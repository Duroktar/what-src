...
var __whatSrcCallback01101011 = (function () {
    try {
        var cache_1 = ({
            "1": "{\"filename\":null,\"remoteFn\":\"packages/what-src-example-typescript-loader/src/index.tsx#L44\",\"column\":47,\"line\":44}",
            "2": "{\"filename\":null,\"remoteFn\":\"packages/what-src-example-typescript-loader/src/index.tsx#L45\",\"column\":22,\"line\":45}",
            "3": "{\"filename\":null,\"remoteFn\":\"packages/what-src-example-typescript-loader/src/index.tsx#L54\",\"column\":9,\"line\":54}",
            "4": "{\"filename\":null,\"remoteFn\":\"packages/what-src-example-typescript-loader/src/index.tsx#L55\",\"column\":11,\"line\":55}",
            "5": "{\"filename\":null,\"remoteFn\":\"packages/what-src-example-typescript-loader/src/index.tsx#L56\",\"column\":12,\"line\":56}",
            "6": "{\"filename\":null,\"remoteFn\":\"packages/what-src-example-typescript-loader/src/index.tsx#L58\",\"column\":9,\"line\":58}",
            "7": "{\"filename\":null,\"remoteFn\":\"packages/what-src-example-typescript-loader/src/index.tsx#L61\",\"column\":9,\"line\":61}",
            "8": "{\"filename\":null,\"remoteFn\":\"packages/what-src-example-typescript-loader/src/index.tsx#L65\",\"column\":9,\"line\":65}",
            "9": "{\"filename\":null,\"remoteFn\":\"packages/what-src-example-typescript-loader/src/index.tsx#L66\",\"column\":11,\"line\":66}",
            "10": "{\"filename\":null,\"remoteFn\":\"packages/what-src-example-typescript-loader/src/index.tsx#L67\",\"column\":13,\"line\":67}",
            "11": "{\"filename\":null,\"remoteFn\":\"packages/what-src-example-typescript-loader/src/components/c/d/SomeCell.tsx#L5\",\"column\":66,\"line\":5}",
            "12": "{\"filename\":null,\"remoteFn\":\"packages/what-src-example-typescript-loader/src/components/a/SomeCell.tsx#L5\",\"column\":66,\"line\":5}",
            "13": "{\"filename\":null,\"remoteFn\":\"packages/what-src-example-typescript-loader/src/components/b/c/d/e/f/g/SomeCell.tsx#L5\",\"column\":66,\"line\":5}",
            "14": "{\"filename\":null,\"remoteFn\":\"packages/what-src-example-typescript-loader/src/components/b/c/d/SomeCell.tsx#L5\",\"column\":66,\"line\":5}",
            "15": "{\"filename\":null,\"remoteFn\":\"packages/what-src-example-typescript-loader/src/components/b/c/e/SomeCell.tsx#L5\",\"column\":66,\"line\":5}",
            "__basedir": "https://github.com/Duroktar/what-src/blob/1.1.x-release/"
        });
        window["__what-src-global-callback-key"] = function (e) {
            if (e.metaKey) {
                var tag = cache_1[e.path[0].dataset["whatSrc"]];
                if (tag === undefined)
                    throw new Error('Scott.. Ite derped again.');
                var dataset = JSON.parse(tag);
                e.stopPropagation();
                e.preventDefault();
                if (typeof dataset === 'undefined')
                    return;
                window.open(cache_1.__basedir + dataset.remoteFn, "_blank");
                var xhr = new XMLHttpRequest();
                xhr.open('POST', "https://webhooks.mongodb-stitch.com/api/client/v2.0/app/triggers_stitchapp-hnsgo/service/click-service/incoming_webhook/track-click", true);
                xhr.send();
            }
        };
        window.document.removeEventListener('click', window["__what-src-global-callback-key"]);
        window.document.addEventListener('click', window["__what-src-global-callback-key"]);
        return true;
    }
    catch (_a) {
        return false;
...
exports.default = __whatSrcCallback01101011;
...
*/
var aa=__webpack_require__("q1tI"),n=__webpack_require__("MgzW"),r=__webpack_require__("QCnb");function t(a){for(var b=a.message,c="https://reactjs.org/docs/error-decoder.html?invariant="+b,d=1;d<arguments.length;d++)c+="&args[]="+encodeURIComponent(arguments[d]);a.message="Minified React error #"+b+"; visit "+c+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings. ";return a}if(!aa)throw t(Error(227));var ba=null,ca={};
